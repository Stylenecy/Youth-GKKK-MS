...
/**
 * Link "Chat via WhatsApp" — renders nothing when the number is missing.
 *
 * The component only ever receives a number that already passed the
 * database gate (getMemberWhatsapp → get_member_whatsapp), so the raw
 * number never appears on a page a plain member can open.
 */
